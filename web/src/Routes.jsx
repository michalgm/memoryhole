...
const MainLayout = React.lazy(() => import('src/layouts/MainLayout/MainLayout'))
const ModelLayout = React.lazy(() => import('src/layouts/ModelLayout/ModelLayout'))
const ScaffoldLayout = React.lazy(() => import('src/layouts/ScaffoldLayout/ScaffoldLayout'))
