        ...
        <tbody>
          {actions.map((action) => (
            <tr key={action.id}>
              ...
              <td>{truncate(action.description)}</td>
              <td>{timeTag(action.start_date)}</td>
              <td>{timeTag(action.end_date)}</td>
              <td>{truncate(action.jurisdiction)}</td>
              <td>{truncate(action.city)}</td>
              <td>{jsonTruncate(action.custom_fields)}</td>
              <td>
