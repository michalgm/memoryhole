...
This password reset link will expire in ${24} hours. If you do not complete the process before then, you will need to start the password reset process again:
